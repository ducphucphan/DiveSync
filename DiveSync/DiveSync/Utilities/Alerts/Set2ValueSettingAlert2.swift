...
final class Set2ValueSettingAlert2: UIViewController {
    ...
    static func showMessage(message: String? = "Set Auto Dim",
        ...
        guard let topVC = UIApplication.shared.topMostViewController(),
            ...
            .instantiateViewController(withIdentifier: "Set2ValueSettingAlert2") as? Set2ValueSettingAlert2 else {
            return
        }
...
extension Set2ValueSettingAlert2: UIPickerViewDelegate, UIPickerViewDataSource {
