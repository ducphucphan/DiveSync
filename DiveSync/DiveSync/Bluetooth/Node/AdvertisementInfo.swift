...
//  DiveSync
//
//  Created by Phan Duc Phuc on 9/16/25.
//
...
extension AdvertisementData {
    ...
    var deviceType: NodeType {
        guard let vendorData = manufacturerData else { return .generic }
...
struct AdvertisementInfo {
    static func getNodeType(deviceId: UInt8, protocolVersion: UInt8) -> NodeType {
